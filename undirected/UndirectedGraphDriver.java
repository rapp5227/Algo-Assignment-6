...
public class UndirectedGraphDriver {
    ...
    public static UndirectedGraph test()
    {
    ...
    public static void main(String[] args){
        ...
        UndirectedGraph graph = UndirectedGraphDriver.test();
        System.out.println(graph.toString());

        System.out.println(graph.numShortestPaths(0,4));
        ...
        // System.out.println(graph2.numShortestPaths(5,3));
    }
